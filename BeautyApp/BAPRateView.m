...
// Here we initialize our instance variables to default values.
- (void)baseInit
{
...
//We support both initWithFrame and initWithCoder so that our view controller can add us via a XIB or programatically.
...
// Loop through our list of images and set the appropriate image based on the rating.
- (void)refresh
{
...
- (void)layoutSubviews
{
    ...
    // Calculations to figure out how to set the frames for each UIImageView.
    ...
    // Loop through and update the frames for each UIImageView.
    for (int i = 0; i < self.imageViews.count; ++i)
    {
